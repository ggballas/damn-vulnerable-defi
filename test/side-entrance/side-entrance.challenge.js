...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const SideEntranceExploitFactory = await ethers.getContractFactory('SideEntranceExploit', attacker);
        let exploit = await SideEntranceExploitFactory.deploy(this.pool.address);
